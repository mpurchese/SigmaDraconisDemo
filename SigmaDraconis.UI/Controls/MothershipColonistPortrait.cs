namespace SigmaDraconis.UI
{
    ...
    public class MothershipColonistPortrait : UIElementBase
    {
        ...
        public MothershipColonistPortrait(IUIElement parent, int x, int y, IColonistPlaceholder colonist)
            : base(parent, x, y, 0, 0)
        {
        ...
        public override void LoadContent()
        {
            ...
            this.W = this.rawColonistTexture.Width * UIStatics.Scale / 200;
            this.H = this.rawColonistTexture.Height * UIStatics.Scale / 200;
