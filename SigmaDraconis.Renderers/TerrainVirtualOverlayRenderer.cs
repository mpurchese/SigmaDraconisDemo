namespace SigmaDraconis.Renderers
{
    ...
    // Has pulsing effect
    public class TerrainVirtualOverlayRenderer : IRenderer, IDisposable
    {
        ...
        public void LoadContent(GraphicsDevice graphicsDevice, ContentManager contentManager)
        {
            ...
            EventManager.Subscribe(EventType.VirtualBuildableArea, delegate (object obj) { this.OnHighlightUpdated(); });
        }
        ...
        public void UpdateBuffers()
        {
            ...
            var isOreScanner = PlayerWorldInteractionManager.CurrentActivity == PlayerActivityType.Build && PlayerWorldInteractionManager.CurrentThingTypeToBuild == ThingType.OreScanner;
            var highlights = TileHighlightManager.TileHighlightsPulsing;
            var buildableTiles = PlayerWorldInteractionManager.CurrentActivitySubType == PlayerActivitySubType.BuildFactory && !isOreScanner ? World.VirtualBuildableTiles : new HashSet<int>();
        ...
        public void Draw()
        {
            ...
            this.effect.Parameters["xGlobalAlpha"].SetValue(0.5f + (0.1f * Mathf.Sin((Environment.TickCount % 1000000) / 300f)));
