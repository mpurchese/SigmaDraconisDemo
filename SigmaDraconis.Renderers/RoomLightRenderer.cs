namespace SigmaDraconis.Renderers
{
    ...
    public class RoomLightRenderer : IRenderer, IDisposable
    {
        ...
        public void LoadContent(GraphicsDevice graphicsDevice, ContentManager contentManager)
        {
            ...
            var texture = content.Load<Texture2D>("Textures\\Lights\\Room");
        ...
        public void UpdateBuffers()
        {
            ...
            var roomTiles = RoomManager.Rooms.Where(r => r.ArtificialLight > 0).SelectMany(r => r.Tiles).ToList();
            var size = roomTiles.Count * 4;
            if (size == 0)
            {
            ...
            foreach (var tile in roomTiles)
            {
                ...
                var c = Color.White;
                vertexArray[i] = new VertexPositionColorTexture { Position = new Vector3(cx - 32f, cy, 0), TextureCoordinate = new Vector2(0f, 1f), Color = c };
                vertexArray[i + 1] = new VertexPositionColorTexture { Position = new Vector3(cx, cy - 16f, 0), TextureCoordinate = new Vector2(0f, 0f), Color = c };
                vertexArray[i + 2] = new VertexPositionColorTexture { Position = new Vector3(cx + 32f, cy, 0), TextureCoordinate = new Vector2(1f, 0f), Color = c };
                vertexArray[i + 3] = new VertexPositionColorTexture { Position = new Vector3(cx, cy + 16f, 0), TextureCoordinate = new Vector2(1f, 1f), Color = c };
