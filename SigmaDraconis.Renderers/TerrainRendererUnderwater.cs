namespace SigmaDraconis.Renderers
{
    ...
    public class TerrainRendererUnderwater : TerrainRendererBase
    {
        ...
        {
            var texture1 = WorldRenderer.Instance.GameTextureContent.Load<Texture2D>(WorldRenderer.Instance.TextureRes == 0 ? "Tiles\\LoRes\\TerrainDirtUnderwater_1" : "Tiles\\TerrainDirtUnderwater_1");
            var texture2 = WorldRenderer.Instance.GameTextureContent.Load<Texture2D>(WorldRenderer.Instance.TextureRes == 0 ? "Tiles\\LoRes\\TerrainDirtUnderwater_2" : "Tiles\\TerrainDirtUnderwater_2");
        ...
        public override void UpdateBuffers()
        {
            ...
            var size = World.BigTilesWithWater.Count * 4;
            if (size == 0) return;
            ...
            foreach (var tile in World.BigTilesWithWater)
            {
                var textureName = tile.GetTextureName();
                var frame = TextureAtlasManager.GetFrame(TextureAtlasIdentifiers.TerrainDirtUnderwater, textureName);
